...
main(int argc, char *argv[])
{
  ...
  if(argc < 3){
   ...
   f:	c7 44 24 04 64 08 00 	movl   $0x864,0x4(%esp)
  16:	00 
  17:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  1e:	e8 75 04 00 00       	call   498 <printf>
    exit();
  ...
  33:	e8 2e 02 00 00       	call   266 <atoi>
  ...
  47:	e8 1a 02 00 00       	call   266 <atoi>
  4c:	89 44 24 18          	mov    %eax,0x18(%esp)
  if (priority < 0 || priority > 20){
  50:	83 7c 24 18 00       	cmpl   $0x0,0x18(%esp)
  55:	78 07                	js     5e <main+0x5e>
  57:	83 7c 24 18 14       	cmpl   $0x14,0x18(%esp)
  5c:	7e 19                	jle    77 <main+0x77>
    printf(2,"Invalid priority (0-20)!\n");
  5e:	c7 44 24 04 7e 08 00 	movl   $0x87e,0x4(%esp)
  65:	00 
  66:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  6d:	e8 26 04 00 00       	call   498 <printf>
    exit();
  72:	e8 81 02 00 00       	call   2f8 <exit>
  }
  changepriority(pid, priority);
  77:	8b 44 24 18          	mov    0x18(%esp),%eax
  7b:	89 44 24 04          	mov    %eax,0x4(%esp)
  7f:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  83:	89 04 24             	mov    %eax,(%esp)
  86:	e8 0d 03 00 00       	call   398 <changepriority>
  exit();
  8b:	e8 68 02 00 00       	call   2f8 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 431:	0f b6 80 e4 0a 00 00 	movzbl 0xae4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 58e:	75 09                	jne    599 <printf+0x101>
          s = "(null)";
 590:	c7 45 f4 98 08 00 00 	movl   $0x898,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 65a:	a1 00 0b 00 00       	mov    0xb00,%eax
...
free(void *ap)
{
 ...
 725:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 72a:	c9                   	leave  
 72b:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 778:	e8 ce fe ff ff       	call   64b <free>
  return freep;
 77d:	a1 00 0b 00 00       	mov    0xb00,%eax
}
 782:	c9                   	leave  
 783:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 796:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 799:	a1 00 0b 00 00       	mov    0xb00,%eax
 79e:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7a1:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7a5:	75 23                	jne    7ca <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7a7:	c7 45 f0 f8 0a 00 00 	movl   $0xaf8,-0x10(%ebp)
 7ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7b1:	a3 00 0b 00 00       	mov    %eax,0xb00
 7b6:	a1 00 0b 00 00       	mov    0xb00,%eax
 7bb:	a3 f8 0a 00 00       	mov    %eax,0xaf8
    base.s.size = 0;
 7c0:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 7c7:	00 00 00 
  }
 ...
 81d:	a3 00 0b 00 00       	mov    %eax,0xb00
      return (void*)(p + 1);
 ...
 828:	eb 38                	jmp    862 <malloc+0xde>
    ...
    if(p == freep)
 82a:	a1 00 0b 00 00       	mov    0xb00,%eax
